    ...
    <div class="poetry-grid">
      ...
      >
        <div class="poetry-header">
          ...
          <span class="poetry-author">[{{ poem.dynasty }}] {{ poem.author }}</span>
        </div>
